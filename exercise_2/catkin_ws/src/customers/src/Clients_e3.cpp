...
public:
  ...
  void customerCallback(const std_msgs::String& msg){
        ...
        {
                //pay back
                std_msgs::Float64 coin_msg; //initialize coin mesage as a standard message of type float
                coin_msg.data = 1.0;
                customer_pub_.publish(coin_msg); //publish coin message
...
int main(int argc, char **argv)
{
        ...
        //initialize classes
        SupeROS_clients Clients_node1(1.0, "tuna","fisher"), Clients_node2(2.0, "carrots","veggies");
